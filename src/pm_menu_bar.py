...
class PmMenuBar:
    ...
    def init_edit_menu(self):
        ...
        copy_record_action.triggered.connect(self.copy_record)
        edit_menu.addAction(copy_record_action)

        edit_menu.addSeparator()

        new_record_action = edit_menu.addAction("新建记录(&N)…")
        new_record_action.triggered.connect(self.new_record)
        ...
        remove_record_action.triggered.connect(self.remove_record)
